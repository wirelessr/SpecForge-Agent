...
class TestImplementAgentTaskDecomposerIntegration:
    ...
    @pytest.mark.skip(reason="Long-running quality comparison test - excluded from performance analysis")
...
class TestTaskDecomposerExecutionFlow:
    ...
    @pytest.mark.skip(reason="Long-running integration test - excluded from performance analysis")
